            ...
            >
              <div className="flex items-center flex-col lg:flex-row lg:mx-1">
                <ul className="flex items-center flex-col lg:flex-row lg:mx-1">
                  <li className="text-md leading-5 text-gray-700 transition-colors duration-300 transform dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 hover:underline md:mx-4 md:my-0">
                    <NavLink to="/" onClick={() => { setMenu("home") }}>Home</NavLink>
                  </li>
                  <li className="text-md leading-5 text-gray-700 transition-colors duration-300 transform dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 hover:underline md:mx-4 md:my-0">
                    <NavLink to="/courses" onClick={() => { setMenu("courses") }}>Courses</NavLink>
                  </li>
                  <li className="text-md leading-5 text-gray-700 transition-colors duration-300 transform dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 hover:underline md:mx-4 md:my-0">
                    <NavLink to="/blogs" onClick={() => { setMenu("blogs") }}>Blogs</NavLink>
                  </li>
                  <li className="text-md leading-5 text-gray-700 transition-colors duration-300 transform dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 hover:underline md:mx-4 md:my-0">
                    <NavLink to="/cart" onClick={() => { setMenu("cart") }}>
